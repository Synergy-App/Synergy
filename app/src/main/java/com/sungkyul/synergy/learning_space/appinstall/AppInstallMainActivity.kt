...
class AppInstallMainActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityAppinstallMainBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAppinstallMainBinding.inflate(layoutInflater)
        setContentView(binding.root)

//        // 교육을 정의해보자!
//        binding.eduScreen.post {
//            binding.eduScreen.course = InstallMainCourse(binding.eduScreen)
//
