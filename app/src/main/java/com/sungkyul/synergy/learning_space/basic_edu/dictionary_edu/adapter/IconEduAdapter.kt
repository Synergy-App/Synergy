...
import com.sungkyul.synergy.learning_space.basic_edu.activity.IconDetailActivity
                    ...
                    MotionEvent.ACTION_UP -> {
                        ...
                        val iconInfo = when (binding.iconTv.text.toString()) {
                            ...
                            "비행기 탑승 모드" -> IconInfo(
                                ...
                                "비행기 탑승 모드",
                                "비행기에 탑승할 때 사용하는 모드로 휴대폰의 통신 기능이 꺼져 전화나 문자, 인터넷 기능을 사용할 수 없는 상태"
                            )
                            "절전 모드" -> IconInfo(
                            ...
                            "이모티콘" -> IconInfo(
                                R.drawable.ic_word_emoji,
                                "이모티콘",
                                "감정이나 느낌을 전달할 때 사용하며, 스티커와 비슷한 그림 기호"
                            )
                            "GPS" -> IconInfo(
                                R.drawable.ic_word_location,
                                "GPS",
                                "사용자의 위치를 파악해 경로를 파악하는 기능\n\n 내 위치, 목적지 경로를 찾아주는 데 사용"
                            )
                            "캡처" -> IconInfo(
                                R.drawable.sebook_no_icon,
                                "캡처",
                            ...
                            "키보드" -> IconInfo(
                                R.drawable.ic_word_keyboard,
                                "키보드",
                                "자판 입력 장치로 휴대폰에서 글자나 기호를 입력할 수 있는 창"
                            )
                            "업데이트" -> IconInfo(
                                R.drawable.ic_word_update,
                                "업데이트",
                            ...
                            "음성 메세지" -> IconInfo(
                                R.drawable.ic_word_voicemessage,
                                "음성 메세지",
