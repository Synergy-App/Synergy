package com.sungkyul.synergy.training_space.naver.result
...
class ExamNaverResultActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_exam_naver_result)
