package com.sungkyul.synergy.training_space.google.result
...
class ExamGoogleResultActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_exam_message_result)
        // SharedPreferences에서 결과를 가져옴
        val sharedPreferences: SharedPreferences =
            getSharedPreferences("PracticeGooglePrefs", Context.MODE_PRIVATE)

        val result1 = sharedPreferences.getBoolean("google_result", true)
