...
import com.sungkyul.synergy.databinding.ActivityResBinding
import com.sungkyul.synergy.edu_courses.ticket.ResCourse
...
class resActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.eduScreen.post {
            binding.eduScreen.course = ResCourse(binding.eduScreen)
