...
data class ScreenLayoutCourse(val eduScreen: EduScreen): EduCourse {
    ...
    init {
        ...
        list.add(EduData().apply {
            ...
            dialog.contentGravity = Gravity.CENTER
            dialog.top = 100.0f/930.0f
            dialog.bottom = 490.0f/930.0f

            cover.boxLeft = 0.0f
            cover.boxTop = 5.0f
            cover.boxRight = width
            cover.boxBottom = 55.0f/930.0f
        ...
        list.add(EduData().apply {
            ...
            cover.boxRight = 110.0f/412.0f
        })

        list.add(EduData().apply {
            dialog.contentText = "이 버튼은<br><b>홈 화면</b>으로<br>돌아갈 수 있습니다."

            cover.boxLeft = 175.0f/412.0f
            cover.boxRight = 235.0f/412.0f
        })
