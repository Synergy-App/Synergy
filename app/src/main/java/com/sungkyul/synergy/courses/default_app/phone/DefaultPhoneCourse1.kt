...
data class DefaultPhoneCourse1(val eduScreen: EduScreen, val activity: AppCompatActivity) : EduCourse {
    ...
    init {
        ...
        list.add(EduData().apply {
            ...
            cover.boxTop = AdaptiveUtils.ratio(700.0f/930.0f)
            cover.boxBottom = AdaptiveUtils.ratio(820.0f/930.0f)
        ...
        val keyViews = hashMapOf<Char, PointF>(
            '1' to PointF(AdaptiveUtils.ratio(0.235f), AdaptiveUtils.ratio(0.495f)),
            '2' to PointF(AdaptiveUtils.ratio(0.45f), AdaptiveUtils.ratio(0.495f)),
            '3' to PointF(AdaptiveUtils.ratio(0.7f), AdaptiveUtils.ratio(0.495f)),
            '4' to PointF(AdaptiveUtils.ratio(0.235f), AdaptiveUtils.ratio(0.565f)),
            '5' to PointF(AdaptiveUtils.ratio(0.45f), AdaptiveUtils.ratio(0.565f)),
            '6' to PointF(AdaptiveUtils.ratio(0.7f), AdaptiveUtils.ratio(0.565f)),
            '7' to PointF(AdaptiveUtils.ratio(0.235f), AdaptiveUtils.ratio(0.645f)),
            '8' to PointF(AdaptiveUtils.ratio(0.45f), AdaptiveUtils.ratio(0.645f)),
            '9' to PointF(AdaptiveUtils.ratio(0.7f), AdaptiveUtils.ratio(0.645f)),
            '*' to PointF(AdaptiveUtils.ratio(0.235f), AdaptiveUtils.ratio(0.725f)),
            '0' to PointF(AdaptiveUtils.ratio(0.45f), AdaptiveUtils.ratio(0.725f)),
            '#' to PointF(AdaptiveUtils.ratio(0.7f), AdaptiveUtils.ratio(0.725f))
        )
